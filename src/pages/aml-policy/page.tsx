            ...
            <div className="flex items-start gap-4 p-4 bg-primary-500/10 border border-primary-500/30 rounded-xl mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-300">
                  CardXC, a digital wallet and payments platform operated by CARDXC LLC, is committed to maintaining strong anti-money laundering (AML) and counter-terrorism financing (CTF) practices. We maintain an AML/CTF compliance program designed to be consistent with applicable laws and regulations and to help prevent our platform from being used for illicit activities.
                </p>
              </div>
            </div>
