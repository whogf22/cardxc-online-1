        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="text-center mb-10">
            <Link to="/" className="inline-flex items-center space-x-3 cursor-pointer group">
              <div className="w-14 h-14 bg-lime-500 rounded-2xl flex items-center justify-center shadow-glow group-hover:shadow-glow-sm transition-all duration-300">
  ...
  return (
    <div className="min-h-screen bg-dark-bg flex items-center justify-center px-4 py-12 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-20 w-80 h-80 bg-lime-500/[0.07] rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-lime-500/[0.07] rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-lime-500/[0.07] rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="dark-card p-8">
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-lime-500/[0.08] rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-lock-password-line text-lime-400 text-3xl"></i>
            </div>
        ...
        <div className="text-center mt-8">
          <Link to="/" className="text-sm text-neutral-500 hover:text-lime-400 transition-colors cursor-pointer">
